...
<section class="hero-section" id="hero" role="banner">
    ...
    <div class="hero-scroll-indicator" aria-hidden="true">
        <button class="scroll-down-btn" onclick="document.getElementById('latest-news').scrollIntoView({behavior: 'smooth'})" aria-label="<?php esc_attr_e('Scroll down to content', 'saab'); ?>">>
